...
const emailInput1: Locator = await page1.locator("#usrname");
const passwordInput1: Locator = await page1.locator("#usremail");
const MobileInput1: Locator = await page1.locator("#usrmb");
...
const emailInput2: Locator = await page2.locator("#usrname");
const passwordInput2: Locator = await page2.locator("#usremail");
const MobileInput2: Locator = await page2.locator("#usrmb");
